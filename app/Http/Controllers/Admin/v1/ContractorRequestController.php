...
//        dd($contractor_request_id,$checklist_id);
        $js = $request->all();
...
//            'checklist_id'=>'required'
//        ];
//        $validator1 = Validator::make($json_de, $rules1);
...
//        dd($validated);
        $rules = [
            ...
            "checklist_item_detail_id.executive_operation_correctly_contractor.true_false" => "required|in:13,14",
            "checklist_item_detail_id.executive_operation_correctly_contractor.description" => "nullable|string|min:3|max:1024",
            "checklist_item_detail_id.documentation_provided_contractor_consistent_executive.true_false" => 'required|in:13,14',
